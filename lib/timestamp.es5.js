(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["Timestamp"] = factory();
	else
		root["Timestamp"] = factory();
...
exports.timestampFromDate = exports.Timezone = undefined;
exports.fromDate = fromDate;

var _Timezone = __webpack_require__(29);

var _Timezone2 = _interopRequireDefault(_Timezone);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var Timezone = exports.Timezone = _Timezone2.default;
...
function fromDate() {
	...
	var timezone = arguments[1];

	var offset = timezone instanceof Timezone ? timezone.toNumber(_Timezone.toNumberOptions.MILLISECONDS) : 0;
	...
	var tz = timezone instanceof Timezone ? timezone.value : (0, _Timezone.fromNumber)(date.getTimezoneOffset(), true).value;
	...
	var milliseconds = (date.getMilliseconds() / 1000).toFixed(3).slice(2, 5);

	return year + '-' + month + '-' + day + ('T' + hours + ':' + minutes + ':' + seconds + '.' + milliseconds) + ('' + tz);
}

var timestampFromDate = exports.timestampFromDate = fromDate;

exports.default = Timestamp.fromDate;
...
exports.toNumberOptions = undefined;

var _sign = __webpack_require__(30);
...
exports.getPrefixFor = getPrefixFor;
exports.getPrefixForSign = getPrefixForSign;
exports.getSignForPrefix = getSignForPrefix;

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

/* eslint-disable class-methods-use-this */

var SUBSTITUTIONS = [[/^gmt$/, 'Z'], [/^utc$/, 'Z'], ['utc', ''], ['gmt', '']];

var toNumberOptions = exports.toNumberOptions = ['MILLENIA', 'CENTURIES', 'DECADES', 'YEARS', 'QUARTERS', 'MONTHS', 'WEEKS', 'DAYS', 'HOURS', 'MINUTES', 'SECONDS', 'MILLISECONDS'].reduce(function (acc, v) {
	acc[v] = v;return acc;
}, {});

var toNumberConfig = (_toNumberConfig = {}, (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.MILLENIA, 1 / (60 * 24 * 7 * 365.25 * 1000)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.CENTURIES, 1 / (60 * 24 * 7 * 365.25 * 100)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.DECADES, 1 / (60 * 24 * 7 * 365.25 * 10)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.YEARS, 1 / (60 * 24 * 7 * 365)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.QUARTERS, 1 / (60 * 24 * 7 * 30 * 3 + 1.25)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.MONTHS, 1 / (60 * 24 * 7 * 30)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.WEEKS, 1 / (60 * 24 * 7)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.DAYS, 1 / (60 * 24)), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.HOURS, 1 / 60), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.MINUTES, 1), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.SECONDS, 60), (0, _defineProperty3.default)(_toNumberConfig, toNumberOptions.MILLISECONDS, 60 * 1000), _toNumberConfig);
...
var Timezone = function () {
  ...
  */
	function Timezone() {
		var timezoneString = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '+0000';
		(0, _classCallCheck3.default)(this, Timezone);
		...
		SUBSTITUTIONS.forEach(function (sub) {
			var _timezoneString$toLow;

			timezoneString = (_timezoneString$toLow = timezoneString.toLowerCase().trim()).replace.apply(_timezoneString$toLow, (0, _toConsumableArray3.default)(sub));
		});

		timezoneString = timezoneString.trim().slice(0, 5);

		var prefix = Timezone.getPrefixFor(timezoneString);

		var tzAbsOffset = prefix === 'Z' ? '' : timezoneString.slice(1);
	...
	(0, _createClass3.default)(Timezone, [{
		key: 'toString',
   ...
   */
		...
		value: function toNumber() {
			var option = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : toNumberOptions.MINUTES;
			var invertSign = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
   ...
   */
		...
		key: 'sign',
		get: function get() {
			return Timezone.getSignForPrefix(this._value);
		}
	}, {
		key: 'prefix',
		get: function get() {
...
Timezone.fromNumber = fromNumber;
Timezone.getPrefixFor = getPrefixFor;
Timezone.getPrefixForSign = getPrefixForSign;
Timezone.getSignForPrefix = getSignForPrefix;
function fromNumber(offset) {
	var invertSign = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;

	var sign = invertSign ? -1 : 1;
	var offsetPrefix = Timezone.getPrefixForSign(offset * sign);
	offset = Math.abs(offset);
	var offsetHours = String(Math.floor(offset / 60)).padStart(2, '0');
	var offsetMinutes = String(Math.floor(offset % 60)).padStart(2, '0');
	var timezoneString = offsetPrefix === 'Z' ? offsetPrefix : '' + offsetPrefix + offsetHours + offsetMinutes;
	return new Timezone(timezoneString);
}

function getPrefixFor(timezoneString) {
	if (!timezoneString || typeof timezoneString !== 'string') {
...
function getSignForPrefix(timezoneString) {
	if (!timezoneString || typeof timezoneString !== 'string') {
